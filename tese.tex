...
% Data da defesa/qualificação/seminário de tese
\date{5}{março}{2015} 		%(mês em maiúsculo, se trabalho em Inglês, e minúsculo se trabalho em Português) 
...
\FRDitadata{25}{março}{2015}				% Data da publicação no ITA.
\FRDitadocnro{DCTA/ITA/DM-018/2015} 			% Número de registro fornecido pela biblioteca
%\FRDitaorgaointerno{\@instFull~-- \@instAbbr}
%Exemplo no caso de pós-graduação: \@instFull -- \@instAbbr
\FRDitapalavrasautor{Cupim; Cimento; Estruturas}
\FRDitapalavrasresult{Cupim; Dilema; Construção}
%Exemplo no caso de graduação (TG):
%\FRDitapalavraapresentacao{Trabalho de Graduação, \@instAbbr, \@instCity, 2015. \NumPenultimaPagina\ páginas.}
%Exemplo no caso de pós-graduação (msc, dsc):
%\FRDitapalavraapresentacao{'\@instAbbr', \@instCity. Curso de Mestrado. Programa de Pós-Graduação em Engenharia Aeronáutica e Mecânica. Área de Sistemas Aeroespaciais e Mecatrônica. Orientador: \advisorTitle~\advisorName. Coorientadora: Prof$^\textnormal{a}$.~Dr$^\textnormal{a}$. Doralice Serra. Defesa em 05/03/2015. Publicada em 25/03/2015.}
